...
var buskerPositions = [
  {
    imgSrc:
      "https://i.pinimg.com/originals/c0/da/57/c0da57e76bde0ccc9fc503bb3f77d217.jpg",
    latlng: new kakao.maps.LatLng(37.497535461505684, 127.02948149502778),
  },
  {
    imgSrc:
      "https://ssl.pstatic.net/tveta/libs/1349/1349760/bdcd665caf6ebdd5faf1_20211015141108350.jpg",
  ...
  useEffect(() => {
    ...
    function createBuskerData() {
      ...
      for (let i = 0; i < tes1.length; i++) {
        ...
        let data = createMarker(
          buskerPositions[0].latlng,
          markerImage,
          infowindow
        );
